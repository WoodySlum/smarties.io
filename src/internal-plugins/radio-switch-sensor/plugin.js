...
function loaded(api) {
    ...
    class RadioSwitchSensorForm extends api.exported.SwitchSensorForm {
         ...
         * @returns {RadioSwitchSensorForm}                 The instance
         */
    ...
    api.sensorAPI.registerForm(RadioSwitchSensorForm);
    ...
    api.sensorAPI.registerClass(RadioSwitchSensor);
}

module.exports.attributes = {
    loadedCallback: loaded,
    name: "radio-switch-sensor",
    version: "0.0.0",
    category: "sensor",
    description: "Radio switch sensor",
