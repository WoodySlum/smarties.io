...
function loaded(api) {
    ...
    class RadioContactSensorForm extends api.exported.ContactSensorForm {
         ...
         * @returns {RadioContactSensorForm}                 The instance
         */
    ...
    api.sensorAPI.registerForm(RadioContactSensorForm);
    ...
    api.sensorAPI.registerClass(RadioContactSensor);
}

module.exports.attributes = {
    loadedCallback: loaded,
    name: "radio-contact-sensor",
    version: "0.0.0",
    category: "sensor",
    description: "Radio contact sensor",
