...
function loaded(api) {
    ...
    class Robonect {
                    ...
                    self.getStatus((err2, res2) => {
                        if (!err && !err2) {
                            ...
                            if (res2.error && res2.error.error_message && !api.exported.FileLock.isLocked("robonect-" + res2.error.unix)) {
                                ...
                                error: {
                                error_code: 2,
                                error_message: "Automower n'a pas reconnu le signal de la boucle",
                                date: "2021-04-10",
                                time: "13:46:10",
                                unix: 1618062370
                                }
        ...
        registerTile(res) {
            ...
            const tile = api.dashboardAPI.Tile("robonect-all", api.dashboardAPI.TileType().TILE_SUB_TILES, null, null, null, null, null, null, 0, 107, ROBONECT_REGISTER_KEY, {miniTiles:miniTiles, buttons:[{auto: iconAuto}, {man: iconMan}, {home: iconHome}, {eod: iconEod}]}, api.webAPI.Authentication().AUTH_USAGE_LEVEL);
