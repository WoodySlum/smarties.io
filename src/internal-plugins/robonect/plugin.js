...
function loaded(api) {
    ...
    class Robonect {
        ...
        registerTile(res) {
            ...
            const tile = api.dashboardAPI.Tile("robonect-all", api.dashboardAPI.TileType().TILE_SUB_TILES, null, null, null, null, null, null, 0, 107, ROBONECT_REGISTER_KEY, {miniTiles:miniTiles, buttons:[{start: iconStart}, {auto: iconAuto}, {man: iconMan}, {home: iconHome}, {eod: iconStop}]}, api.webAPI.Authentication().AUTH_USAGE_LEVEL);
