...
const REFRESH_TIME = 5 * 60; // Every 5 minutes
...
function loaded(api) {
    ...
    api.iotAPI.registerApp("app", "esp8266-weather-station", "Nodemcu Weather station", 7, api.iotAPI.constants().PLATFORMS.ESP8266, api.iotAPI.constants().BOARDS.NODEMCU, api.iotAPI.constants().FRAMEWORKS.ARDUINO, ["esp8266"], espPlugin.generateOptions(espPlugin.constants().MODE_LIGHT_SLEEP, REFRESH_TIME), wiringSchema);
