...
class HautomationCore {
    ...
    constructor(runnerEventBus) {
        ...
        // Alarm module
        this.alarmManager = new AlarmManager.class(this.confManager, this.formManager, this.webServices, this.dashboardManager, this.userManager, this.sensorsManager, this.translateManager);
