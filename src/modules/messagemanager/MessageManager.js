...
class MessageManager {
    ...
    constructor(pluginsManager = null, eventBus, userManager, dbManager, webServices, translateManager, dashboardManager, scenarioManager, cachePath) {
        ...
        const tile = new Tile.class(this.dashboardManager.themeManager, "chat", Tile.TILE_GENERIC_ACTION_DARK, Icons.icons["chat"], null, this.translateManager.t("tile.chat"), null, background, null, 0, 500, "chat");
