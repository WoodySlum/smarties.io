...
class AlarmManager {
    ...
    registerTile() {
        ...
        const tile = new Tile.class(this.dashboardManager.themeManager, "alarm", Tile.TILE_GENERIC_ACTION_STATUS, Icons.icons["alarm"], null, this.translateManager.t("alarm.tile.title"), null, background, null, this.alarmStatus()?1:0, 5, SWITCH_ALARM_ROUTE_BASE, null, Authentication.AUTH_GUEST_LEVEL);
