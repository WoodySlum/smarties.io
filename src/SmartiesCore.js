...
class SmartiesCore {
    ...
    constructor(runnerEventBus, smartiesRunnerConstants) {
        ...
        // Ai
        this.aiManager = new AiManager.class(AppConfiguration, this.eventBus, EVENT_STOP, this.timeEventService, this.environmentManager, this.themeManager, this.translateManager, this.threadsManager);
        ...
        this.deviceManager = new DeviceManager.class(this.confManager, this.formManager, this.webServices, this.radioManager, this.dashboardManager, this.scenarioManager, this.translateManager, this.environmentManager, this.botEngine, this.sensorsManager, this.eventBus, this.dbManager, this.aiManager, this.timeEventService);
        // Alarm module
