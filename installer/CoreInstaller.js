...
module.exports = {install:(installationManager) => {
    ...
    installationManager.register("0.0.3", ["arm", "arm64"], "apt-get install -y --allow-unauthenticated git python-pip python3-pip && pip install -U platformio", true, true);
    ...
    installationManager.register("0.0.47", ["arm", "arm64"], "apt-get install -y --allow-unauthenticated coreutils", true, true); // Bot engine
