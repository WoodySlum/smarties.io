...
describe("UserManager", function() {
    ...
    it("default constructor should fill correctly elements", function() {
        ...
        const userManager = new UserManager.class(core.confManager, core.formManager, core.webServices, core.dashboardManager, null, core.scenarioManager, core.environmentManager, core.translateManager, core.themeManager);
